...
public static class MoveData
{
    ...
    public static readonly string[] Names = new string[]
    {
		...
		"PETAL DANCE", "PIN MISSLE", "POISON GAS", "POISONPOWDER", "POISON STING",	//91 - 95
		...
		"TAKE DOWN", "TELEPORT", "THRASH", "THUNDER", "THUNDERPUNCH",				//146 - 150
		"THUNDERSHOCK", "THUNDER WAVE", "THUNDERBOLT", "TOXIC", "TRANSFORM",		//151 - 155
